        ...
        <div className="footer-grid">
          ...
          <div className="footer-brand">
            ...
            <p className="footer-blurb">
              Simple, fast, and tidy customer support. Track issues, collaborate,
              and resolve tickets without the clutter.
            </p>
          </div>
...
function IconFacebook() {
  return (
    <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor"
      style={{ marginRight: 8, opacity: 0.9 }}>
      <path d="M22 12C22 6.48 17.52 2 12 2S2 6.48 2 12c0 5 
...
function IconLinkedIn() {
  return (
    <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor"
      style={{ marginRight: 8, opacity: 0.9 }}>
      <path d="M19 3A2 2 0 0 1 21 5V19A2 2 0 0 1 
...
function IconMail() {
  return (
    <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor"
      style={{ marginRight: 8, opacity: 0.9 }}>
      <path d="M3 6.75A2.75 2.75 0 0 1 5.75 4h12.5A2.75 
